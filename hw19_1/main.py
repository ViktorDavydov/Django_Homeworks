    ...
    <div class="container">
        <header>
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                ...
                <p class="fs-5 text-body-secondary">Вы находитесь на сайте, предназначенном для
                    продажи товаров</p>
            </div>
        </header>
        ...
        <h2 class="display-4 fw-normal text-body-emphasis text-center">FAQ</h2>
        <div class="row">
            <p class="d-inline-flex gap-1">
                <button class="btn btn-primary form-control" type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#collapseButton1" aria-expanded="false"
                        aria-controls="collapseExample">
                    Как купить?
                </button>
                <button class="btn btn-primary form-control" type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#collapseButton2" aria-expanded="false"
                        aria-controls="collapseExample">
                    Как доставить?
                </button>
                <button class="btn btn-primary form-control" type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#collapseButton3" aria-expanded="false"
                        aria-controls="collapseExample">
                    Какая гарантия?
                </button>
            </p>
            ...
            <div class="collapse" id="collapseButton1">
                <div class="card card-body">
                    Укажите Имя и Почту и мы Вам перезвоним!
                </div>
            </div>
            <div class="collapse" id="collapseButton2">
                <div class="card card-body">
                    Доставка осуществляется Почтой России, OZON, Wildberries.
                </div>
            </div>
